...
function init() {
    ...
    // const container = document.getElementById('three-container-3');
    const container = document.getElementById('example-container-3');
    ...
    const loader = new GLTFLoader().setPath('public/scene0030_00_merged/');
